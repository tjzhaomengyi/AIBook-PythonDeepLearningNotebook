...
'''二元词化，例子：the cat sat on the mat => {the, the cat, cat, cat sat, sat, sat on, on, on the, the mat, mat}'''
...
print(f"Test acc: {model.evaluate(binary_2gram_test_ds)[1]:.3f}") #0.895